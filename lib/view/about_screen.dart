                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.person,size: 35,),
                               SizedBox(width: 10,),
                              Text("Aboout",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                               Text("Me",style: TextStyle(color:Color(0xff2187DF),fontSize: 40,fontWeight: FontWeight.bold),)
                            ],
                          ),
                          SizedBox(height: 20,),
